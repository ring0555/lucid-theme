jQuery(document).ready(function(n){n(".nav-button").click(function(){n(".nav-lines").hasClass("open")?(n(".nav-lines").removeClass("open"),n(".nav-lines").slideUp()):(n(".nav-lines").addClass("open"),n(".nav-lines").slideDown())})});
